# Update_Pedestrian_data.py
# This is the main script to retrieve all events
# from PEDEVT enabled sensors and save in CSV files
...
from Download_Pedestrian_Events.CreateStartStopDates import start_stop_dates
from GET_PEDEVT_by_assetUid import get_events
from Combine_PEDEVT import aggregate_events
